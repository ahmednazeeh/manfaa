...
import '../features/market/product_screen.dart';
...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    redirect: (context, state) {
      ...
      final wantsProtected = _protectedPrefixes.any(
    ...
    routes: [
      ...
      GoRoute(
        path: '/qr',
        pageBuilder: (_, _) =>
            const MaterialPage(fullscreenDialog: true, child: QrScreen()),
      ),
            ...
            routes: [
              GoRoute(
                ...
                routes: [
                  ...
                  GoRoute(
                    // Above ':branchId' for the same reason the address route
                    // is — the branch parameter would otherwise swallow it.
                    path: 'product/:id',
