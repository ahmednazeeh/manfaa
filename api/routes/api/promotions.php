...
Route::prefix('merchant')->middleware('auth:merchant')->group(function () {
    ...
    Route::post('promotions', [PromotionController::class, 'store'])->middleware(EnsureMerchantOwner::class);
    Route::post('promotions/{id}/publish', [PromotionController::class, 'publish'])->whereNumber('id')->middleware(EnsureMerchantOwner::class);
