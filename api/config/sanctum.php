...
return [
    ...
    */
    ...
    // The default 'web' guard does not exist here — the three session guards
    // from config/auth.php are checked before falling back to bearer tokens.
    'guard' => ['admin', 'merchant', 'customer'],
