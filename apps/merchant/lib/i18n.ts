...
/**
 * i18n bootstrap (§2 localisation) for the merchant panel, mirroring the
 * customer app: user-facing strings go through t() against locales/en.json,
 * so the Dhivehi pass is a translation file plus an RTL flip — never a code
 * change.
 *
 ...
 * the MVR convention — so formatters stay locale-independent by design.
 *
...
/** localStorage key persisting the merchant user's language choice. */
